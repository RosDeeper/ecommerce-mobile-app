          ...
          <View className="bg-white rounded-t-3xl p-6">
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {["Home", "Work", "Other"].map((t) => (
                  <TouchableOpacity 
                    ...
                    className={`
                      ...
                      ${type === t ? 'bg-primary border-primary' : 'bg-white border-gray-300'}
                    `}
                  >
              ...
              <TouchableOpacity className="flex-row items-center mb-8" onPress={() => setIsDefault(!isDefault)}>
                <View className={`
                  w-5 h-5 border rounded mr-2 items-center justify-center 
              ...
              <TouchableOpacity 
                ...
                onPress={handleSaveAddress} disabled={submitting}
              >
                {submitting ? (
