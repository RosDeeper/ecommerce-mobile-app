    ...
    <View className="flex-1 bg-white">
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        <View className="relative h-[450px] bg-gray-100 mb-6">
          ...
          {/* Header Actions */}
          <View className="absolute top-12 right-4 left-4 flex-row justify-between items-center z-10">
            <TouchableOpacity
      ...
      {/* Footer */}
      <View className="absolute bottom-3 left-0 flex-row right-0 p-4 bg-white border-t border-gray-100">
        <TouchableOpacity 
